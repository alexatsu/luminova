...
import { Options, RenderMark, RenderNode } from "@contentful/rich-text-react-renderer";
...
const renderNode: RenderNode = {
  ...
  [BLOCKS.EMBEDDED_ASSET]: (node) => <img alt="" src={node.data.target.fields.file.url} />,
  ...
  [INLINES.ENTRY_HYPERLINK]: (node, children) => <a href={node.data.target.sys.id}>{children}</a>,
